...
// an immutable registry-installed EngineObservationAdapter after the vendor
// has produced the authoritative launch/profile, then calls ValidateReadings
// before Preflight, plan materialization, or any execution effect.
type Reading struct {
	fact    Fact
	outcome ReadOutcome
}
